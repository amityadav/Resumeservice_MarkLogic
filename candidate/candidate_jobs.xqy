...
<body>
	{
		...
		let $jobs := clib:get-matching-jobs($candidate/cd:resume/cd:skills)
		return
						...
						<div class="floatleft1">
							<span class="navyblue">
								<span class="selected" id="recieved_count">
									Matching Jobs (<span class="green1">{fn:count($jobs)}</span>)
								</span>
							</span>
						</div>
						<div class="height15"></div>
			...
			<div class="rightcol1">
				<div class="box">
					...
					<div class="boxbg">
						...
						<div>
								{
									$candidate/cd:login/text(),
									<br/>,
									$candidate/cd:email/text(),
									<br/>,
									$candidate/cd:resume/cd:resume-title/text()
								}
						</div>
						<div class="clearer"></div>
					  </div>
